        ...
        <div className="flex-1 overflow-y-auto px-8 py-8">
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8 anim-fade-up">
            <div>
              ...
              <h1 className="text-2xl font-extrabold text-indigo-950 font-sora flex items-center gap-3 flex-wrap">
                {esEvento
                ...
                {esEvento && !moodActivo && (
                  <span className="px-2 py-0.5 rounded-full bg-slate-200 text-slate-500 text-[11px] font-extrabold uppercase tracking-wider">
                    Evento finalizado
                  </span>
                )}
              </h1>
            ...
            <div className="flex gap-2 flex-wrap items-center justify-end">
              <button
                ...
                disabled={esEvento && !moodActivo}
                className={`btn-secondary px-3 py-2 text-[11px] font-bold uppercase tracking-wider flex items-center gap-1.5 whitespace-nowrap ${esEvento && !moodActivo ? 'opacity-40 cursor-not-allowed' : ''}`}
              >
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 mb-8">
            ...
            <div className="xl:col-span-2 card p-6 bg-white border border-slate-100 shadow-sm rounded-2xl anim-fade-up delay-2">
              {esEvento && !moodActivo && (
                <div className="flex items-center gap-2 mb-4 px-3 py-2.5 rounded-xl bg-slate-100 border border-slate-200">
                  <span className="text-xs text-slate-500 leading-snug">
                    Este evento ya finalizó. Los participantes que respondieron se muestran abajo.
                  </span>
                </div>
              )}
