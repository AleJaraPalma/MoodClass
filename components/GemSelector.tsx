    ...
    >
      ...
      >
        <defs>
          ...
          <linearGradient id={`gem-grad-${color}-${lit}`} x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <linearGradient id={`gem-shine-${color}-${lit}`} x1="0%" y1="0%" x2="60%" y2="60%">
